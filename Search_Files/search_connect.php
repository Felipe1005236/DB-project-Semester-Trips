        ...
        if($result && $result->num_rows > 0) {
            ...
            switch($search_type) {
                ...
                case 'students':
                    ...
                    break;
                case 'cuisine':
                    echo "<th class=\"destination_name\">Destination name</th>";
                    echo "<th class=\"location\">Location</th>";
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td><a class=\"hidden-link\" href=\"details_page.php?dest_id=" . $row["dest_id"] . "&type=" . $search_type . "\">" . $row["destination_name"] . "</a></td>";
                echo "<td>" . $row["location"] . "</td>"; 
                if ($search_type === 'max_fee' || $search_type === 'cuisine') {
